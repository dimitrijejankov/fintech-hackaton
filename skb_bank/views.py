...
class RestView(View):
    ...
    def get(self, request):
        ...
        cluster_list, cluster_centers = dbscan_cluster(all_clients)

        return JsonResponse({"message": "Groups clients generated by grouping them by age, income and intentions",
